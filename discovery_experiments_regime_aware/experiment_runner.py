...
# Import from the regime_aware package to use the updated baselines
from discovery_experiments_regime_aware.baselines import BaselineLinear, BaselinePolynomial, BaselineCompression, BaselineSpline, BaselineKernelRidge
from discovery_experiments_regime_aware.metrics import approximate_description_length, stability_under_perturbation, cross_run_consistency, intervention_sensitivity
from discovery_experiments_regime_aware.experiment_config import EXPERIMENT_CONFIG
    ...
    for category, config in EXPERIMENT_CONFIG.items():
        ...
        for params in param_sets:
            ...
            for seed in seeds:
                ...
                data_intervention = generate_world_data(world_type, params_intervention, steps=200, seed=seed+9999)
                ...
                for baseline in baselines:
                    ...
                    # Fit on base data WITH METADATA
                    ...
                    stability = None
                    if data_perturbed:
                        # Perturbed run also gets metadata
                    ...
                    result_record = {
                        ...
                        "regime_aware": True, # Flag this run
                        "raw_res": res
                    }
